...
\begin{document}
\title{Measuring the angular distribution fo the cosmological parameters.} 
...
\frame{
 \frametitle{Simple Example:ANN-z}
...
CAMB: Code for Anisotropies in the Cosmic Background (REFERENCIA)
\begin{center}
...
\begin{itemize}
 ...
 \item This technique can be easily extended to use more cosmological information as features (BAO, correlation function, SZ emission).
