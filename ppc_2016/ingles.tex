 ...
 \frametitle{Application of the MeSsI Algorithm to spectroscopy catalogues}
  \begin{itemize}
   \item We find 12 Clusters with high probability of been in a merger in the SDSS DR7.
    \item We find 4 Clusters with high probability of been in a merger in the WINGS Clusters.
   \item We find 16 Clusters with high probability of been in a merger in the HECs Clusters.
  \end{itemize}
}
...
\frame{
 ...
 \begin{itemize}
  \item Perform astrophysical test over our sample of colliding cluster candidates looking for
...
\frame{
 ...
 \end{itemize}
 We will make a ligth-cone mock and re-calibrate our machine learning
 algorithm for high-redshift clusters.
}
\frame{
 \frametitle{Future Work}
 \begin{itemize}
...
\frame{
 \frametitle{Future Work}
 \begin{itemize}
  \item Study the physical properties of the galaxies that belong to the identified coliding substructures, ordering
 them in a temporal line.
 \end{itemize}
}
\frame{
 \frametitle{Future Work}
