...
\begin{center}
 \includegraphics[scale=0.18]{./predicciones_pre.pdf}
...
\begin{figure}[l]
 \includegraphics[scale=0.4,keepaspectratio=true]{./pixelado_pre.pdf}
\end{figure}
}
...
\begin{figure}[ht!]
 \centering
 \includegraphics[scale=0.5,keepaspectratio=true]{./pixel1_pre.pdf}
...
\begin{figure}[ht!]
 \centering
 \includegraphics[scale=0.5,keepaspectratio=true]{./pixel1_reconstruction_pre.pdf}
 % pixel1.pdf: 0x0 pixel, 300dpi, 0.00x0.00 cm, bb=
\end{figure}
}
\frame{
\begin{figure}[ht!]
 \centering
 \includegraphics[scale=0.5,keepaspectratio=true]{./pixel2_pre.pdf}
 % pixel1.pdf: 0x0 pixel, 300dpi, 0.00x0.00 cm, bb=
\end{figure}
}
\frame{
\begin{figure}[ht!]
 \centering
 \includegraphics[scale=0.5,keepaspectratio=true]{./pixel2_reconstruction_pre.pdf}
 % pixel1.pdf: 0x0 pixel, 300dpi, 0.00x0.00 cm, bb=
\end{figure}
}
\frame{
